...
do
  local state = newScenario({ terminal = konsole })
  assert(type(state.binds["SUPER + SHIFT + code:20"]) == "function")
  assert(state.binds["SUPER + SHIFT + underscore"] == nil,
